(() => {
    ...
    const slider = document.querySelector(".slider-tariff__slider");
    let mySwiper;
    const sliderSecond = document.querySelector(".slider-steps__slider");
    let mySwiperSecond;
    function initSliders() {
        if (window.innerWidth <= 1e3 && "false" == slider.dataset.mobile) if (document.querySelector(".slider-tariff__slider")) {
        ...
        //!                    STEPS SLIDER
                if (window.innerWidth <= 767.98 && "false" == sliderSecond.dataset.mobile) if (document.querySelector(".slider-steps__slider")) {
            mySwiperSecond = new core(".slider-steps__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
        ...
        if (window.innerWidth > 767.98) {
            ...
            if (sliderSecond.classList.contains("swiper-initialized")) mySwiperSecond.destroy();
        }
        //!                    TESTIMONIALS SLIDER
                if (document.querySelector(".slider-testimonials__slider")) {
            mySwiperSecond = new core(".slider-testimonials__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: false,
